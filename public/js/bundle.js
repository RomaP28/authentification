      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/users/resetPassword/".concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/users/".concat(url),
              data: data
            });
          case 4:
            res = _context.sent;
